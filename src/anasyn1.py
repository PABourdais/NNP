...
class TableSymbole: #Definition de la classe Symbole
	...
	def ajout(self,scope):
		self.table_symbole.append(scope)
...
class Scope: #Definition de la classe Scope
	...
	def ajout(self,identifierTable):
		...
		self.tableau_identificateur.append(identifierTable)

	def afficher(self):
		print "scope.afficher"
		print str (self.tableau_identificateur)
...
class Identificateur: #Definition de la classe Identificateur	
	...
	def setType(self, nature):
		self.type = nature
	
	def afficher(self):
		print "ident.afficher"
		print str (self.nom+self.type)
...
########################################################################				 	
def main():
 	tableaudessymboles = Scope("Global")
